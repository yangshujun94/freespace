...
class TRANSFORM
{
    public:
        ...
        float      gfPandarPoseInVehicle[6];

        float      gfTransformPandar2Vehicle[4][4];
...
int TRANSFORM::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfPandarPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->gfTransformPandar2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int TRANSFORM::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfPandarPoseInVehicle[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->gfTransformPandar2Vehicle[a0][0], 4);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
uint64_t TRANSFORM::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x6cf66ff4e3be62f7LL +
