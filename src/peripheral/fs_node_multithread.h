...
#include <lcm/Lidar_FreeSpace.hpp>
...
namespace fs
{
  ...
  public:
      ...
      Node(NODE_NAME)
    {
      init();
      //创建两个执行器
      this->group_timer_       = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
      this->group_subcription_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);

      //初始化订阅选项， 关联callback group
      this->options_subscription_          = rclcpp::SubscriptionOptions();
      options_subscription_.callback_group = this->group_subcription_;

      //      //创建一个定时器并将其关联到 group_timer
  ...
  private:
    rclcpp::CallbackGroup::SharedPtr group_subcription_;
    rclcpp::CallbackGroup::SharedPtr group_timer_;
    rclcpp::SubscriptionOptions      options_subscription_;
    ...
    std::unordered_map<fs::SensorId, rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr> map_pub_img_ = {
...
#endif // -- CFG_USE_SVC
      {fs::SensorId::CAMERA_FW, this->create_publisher<sensor_msgs::msg::Image>("/fs/FW_canvas", 1000 / PROCESS_PERIOD_MS)},
      ...
      { fs::SensorId::CAMERA_RR,
        this->create_publisher<sensor_msgs::msg::Image>("/fs/RR_canvas", 1000 / PROCESS_PERIOD_MS) }
    };
...
// #endif
    ...
    void subscribeGates(std::unique_ptr<uto::proto::PerceptionGates> msg_ptr);
    ...
    uto::Subscriber<uto::proto::CameraCalib> calib_fw_sub_ptr_{CALIB_FW_TOPIC, this, [this](auto&& PH1) { subscribeCalibFW(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_fn_sub_ptr_{CALIB_FN_TOPIC, this, [this](auto&& PH1) { subscribeCalibFN(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_fl_sub_ptr_{CALIB_FL_TOPIC, this, [this](auto&& PH1) { subscribeCalibFL(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_fr_sub_ptr_{CALIB_FR_TOPIC, this, [this](auto&& PH1) { subscribeCalibFR(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_rw_sub_ptr_{CALIB_RW_TOPIC, this, [this](auto&& PH1) { subscribeCalibRW(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_rn_sub_ptr_{CALIB_RN_TOPIC, this, [this](auto&& PH1) { subscribeCalibRN(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_rl_sub_ptr_{CALIB_RL_TOPIC, this, [this](auto&& PH1) { subscribeCalibRL(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraCalib> calib_rr_sub_ptr_{CALIB_RR_TOPIC, this, [this](auto&& PH1) { subscribeCalibRR(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};

    uto::Subscriber<uto::proto::VehiclePose>         pose_sub_ptr_{VEHICLE_POSE_TOPIC, this, [this](auto&& PH1) { subscribeVehiclePose(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::PerceptionFreespace> fs_lidar_sub_ptr_{LIDAR_FS_TOPIC, this, [this](auto&& PH1) { subscribeFsLidar(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
...
//    uto::Subscriber<uto::proto::MechanicalInfo> vehicle_config_sub_ptr_{MECHANICAL_INFO_TOPIC, this, [this](auto&& PH1) { subscribeFsLidar(std::forward<decltype(PH1)>(PH1)); }};
    ...
    uto::Subscriber<uto::proto::CameraFreespace>     fs_fw_sub_ptr_{FS_FW_TOPIC, this, [this](auto&& PH1) { subscribeFsFW(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::CameraFreespace>     fs_fn_sub_ptr_{FS_FN_TOPIC, this, [this](auto&& PH1) { subscribeFsFN(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
#endif
    uto::Subscriber<uto::proto::PerceptionObstacles> vot_sub_ptr_{VOT_OBJECTS_TOPIC, this, [this](auto&& PH1) { subscribeVotObject(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::PerceptionGates>     gates_sub_ptr_{GATES_TOPIC, this, [this](auto&& PH1) { subscribeGates(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::PerceptionLanes>     lanes_fc_sub_ptr_{LANE_FC_TOPIC, this, [this](auto&& PH1) { subscribeFCLanes(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::PerceptionLanes>     lanes_rc_sub_ptr_{LANE_RC_TOPIC, this, [this](auto&& PH1) { subscribeRCLanes(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
    uto::Subscriber<uto::proto::PerceptionLanes>     lanes_sub_ptr_{LANE_TOPIC, this, [this](auto&& PH1) { subscribeLanes(std::forward<decltype(PH1)>(PH1)); }, rclcpp::QoS(10), options_subscription_};
#if FS_CHECK(CFG_USE_ROAD_MODEL)
  ...
  private:
    ...
    fs::RingBuffer<std::unique_ptr<Lidar_FreeSpace>, MSG_BUFFER_SIZE>            fs_lidar_buffer_;
    fs::RingBuffer<std::unique_ptr<FS_BEV::CameraFreespace>, MSG_BUFFER_SIZE>    fs_bev_buffer_;
    ...
    LidarFSPtr                               parseLidarFreespace(const Lidar_FreeSpace* lidar_fs_lcm_ptr);
    bool                                     getAlignedVcu(int64_t timestamp, ObjectState& ego_state);
    std::unique_ptr<FS_BEV::CameraFreespace> cloneBevFs(std::unique_ptr<FS_BEV::CameraFreespace>& bev_fs_ptr);
    bool                                     getReverse();
    ...
    void                                     getAlignedInputs(std::unique_ptr<Lidar_FreeSpace>&         fs_lidar_lcm_ptr,
                                                              std::unique_ptr<FS_BEV::CameraFreespace>& fs_bev_lcm_ptr,
