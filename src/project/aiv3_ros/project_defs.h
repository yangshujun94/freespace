#ifndef PROJECT_AIV3_ROS_DEFS_H_
#define PROJECT_AIV3_ROS_DEFS_H_
#include <cstdint>
namespace fs
{
  // topics
  ...
  static constexpr char CALIB_FN_TOPIC[]     = "/calib/cam_fcf";
  static constexpr char CALIB_FL_TOPIC[]     = "/calib/cam_fcf";
  static constexpr char CALIB_FR_TOPIC[]     = "/calib/cam_fcf";
  static constexpr char CALIB_RW_TOPIC[]     = "/calib/cam_fcf";
  static constexpr char CALIB_RN_TOPIC[]     = "/calib/cam_fcf";
  static constexpr char CALIB_RL_TOPIC[]     = "/calib/cam_fcf";
  static constexpr char CALIB_RR_TOPIC[]     = "/calib/cam_fcf";
  ...
  static constexpr char IMAGE_FL_TOPIC[]     = "/hal/sensor/cam_flb_jpeg";
  static constexpr char IMAGE_FR_TOPIC[]     = "/hal/sensor/cam_frb_jpeg";
  ...
  static constexpr char IMAGE_RL_TOPIC[]     = "/hal/sensor/cam_blf_jpeg";
  static constexpr char IMAGE_RR_TOPIC[]     = "/hal/sensor/cam_brf_jpeg";
  ...
  static constexpr char IMAGE_SFW_TOPIC[] = "/hal/sensor/fisheye_fcf_jpeg";
  static constexpr char IMAGE_SFL_TOPIC[] = "/hal/sensor/fisheye_fll_jpeg";
  static constexpr char IMAGE_SFR_TOPIC[] = "/hal/sensor/fisheye_frr_jpeg";
  static constexpr char IMAGE_SRL_TOPIC[] = "/hal/sensor/fisheye_bll_jpeg";
  static constexpr char IMAGE_SRR_TOPIC[] = "/hal/sensor/fisheye_brr_jpeg";
  static constexpr char IMAGE_SRW_TOPIC[] = "/hal/sensor/fisheye_bcb_jpeg";
...
#endif //PROJECT_AIV3_ROS_DEFS_H_
