#ifndef PROJECT_AIV5_LCM_DEFS_H_
#define PROJECT_AIV5_LCM_DEFS_H_
#include <cstdint>
namespace fs
{
  // -- lcm port
  ...
  static constexpr int CAMERA_CENTER_WIDTH  = 3840;
  static constexpr int CAMERA_CENTER_HEIGHT = 2160;
  static constexpr int CAMERA_SIDE_WIDTH    = 1920;
  static constexpr int CAMERA_SIDE_HEIGHT   = 960;
  ...
  static const std::map<const SensorId, const std::string> SENSOR_ID_TO_STRING = {{SensorId::CAMERA_FW, "fcf"},
                                                                                  {SensorId::CAMERA_FN, "none"},
                                                                                  {SensorId::CAMERA_FL, "flb"},
                                                                                  {SensorId::CAMERA_FR, "frb"},
                                                                                  {SensorId::CAMERA_RL, "blf"},
                                                                                  {SensorId::CAMERA_RR, "brf"},
                                                                                  {SensorId::CAMERA_RW, "bcb"},
                                                                                  {SensorId::CAMERA_RN, "none"}};
...
#endif //PROJECT_AIV5_LCM_DEFS_H_
